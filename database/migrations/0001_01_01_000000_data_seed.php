...
return new class extends Migration
{
    ...
    {        
        ...
        $db = new PDO('mysql:dbname=' . config('database')['connections']['mysql']['database'] . ';host=' . env('DB_HOST') . ';port=' . env('DB_PORT'), config('database')['connections']['mysql']['username'], env('DB_PASSWORD'));
